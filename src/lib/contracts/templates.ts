...
1. **Payer le loyer et les charges** aux termes convenus, à savoir le 1er à 5 de chaque mois, par virement bancaire, Mobile Money (FedaPay) ou tout autre moyen via la plateforme KAZA (escrow sécurisé).
...
À l'expiration de ce terme, le bail sera reconduit tacitement pour des périodes successives d'une (1) année, à défaut de congé délivré par l'une des parties dans les conditions et délais prévus par la loi (préavis de 3 mois pour le Bailleur, 1 mois pour le Locataire).`,
    },
    {
      ...
      required: true,
      editable: true,
      body: `Le loyer mensuel est fixé à **{{rent}}** payable d'avance, au plus tard le **5 de chaque mois**, via la plateforme KAZA (escrow sécurisé FedaPay / Mobile Money / virement bancaire).
