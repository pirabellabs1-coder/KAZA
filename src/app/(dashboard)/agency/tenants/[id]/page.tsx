    ...
    <div className="mx-auto max-w-3xl space-y-6">
      <Button asChild variant="ghost" size="sm" className="-ml-2 gap-1.5">
        <Link href="/agency/tenants">
          <ArrowLeft className="size-4" /> Tous les locataires
        </Link>
      </Button>
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-2">
            <CardTitle className="flex items-center gap-2 text-sm text-muted-foreground">
              <AlertOctagon className="size-4 text-rose-500" /> Litiges ouverts
            </CardTitle>
          </CardHeader>
          <CardContent>
            <p className="font-heading text-2xl font-bold text-kaza-navy">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Baux chez votre agence</CardTitle>
        </CardHeader>
      ...
      <div className="flex flex-wrap gap-2">
        <Button asChild variant="outline" className="gap-2">
          <Link href="/agency/disputes">
            <AlertOctagon className="size-4" /> Signaler un litige
          </Link>
        </Button>
        <Button asChild variant="outline" className="gap-2">
          <Link href="/agency/payments">
