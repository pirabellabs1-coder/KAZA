...
export const REWARDS: Reward[] = [
  {
    ...
    description: "Ajoutez 500 FCFA directement dans votre portefeuille Kaabo.",
    icon: Wallet,
    accent: "kaza-blue",
  },
  {
  ...
  },
  {
    ...
    description: "Profitez de tous les avantages Kaabo Premium pendant 30 jours.",
    icon: Star,
    accent: "kaza-navy",
  },
  {
  ...
  },
  {
    ...
    description: "Votre loyer du mois est pris en charge par Kaabo.",
    icon: Home,
    accent: "kaza-navy",
  },
  {
    ...
    description: "12 mois de Kaabo Premium gratuits — la récompense ultime.",
    icon: Crown,
    accent: "kaza-warning",
  },
];
